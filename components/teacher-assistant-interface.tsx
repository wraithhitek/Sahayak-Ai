...
import StudyPlanOutput from '@/components/study-plan-output';
...
export default function TeachingAssistant() {
          ...
          <div className="min-h-screen flex items-center justify-center bg-white px-6 py-10 relative">
            <div className="relative w-[400px] h-[400px] ml-[200px]">
              <Image
                ...
                width={400}
                height={400}
                className="object-contain ml-[20px] h-auto"
                priority
              />
  ...
  return (
    <>
        ...
        <div id="pdf-content">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                placeholder="Type instructions like 'Make the notes interesting'"
                value={instructions}
          ...
          {notesGenerated &&<NotesOutput notes={notes} setNotes={setNotes} />}
          ...
          <PDFExport enabled={mergeAndDownload} />
      ...
      />
<StudyPlanOutput studyPlan={studyPlan} />
          {/* ✅ Final Success Message Block */}
          {notesGenerated && (
